...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // this whole structure is loosely coupled, we can add or make changes of any component of PC
        // so that adding or removing objects will not affect other classes!!!
